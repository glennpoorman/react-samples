...
//
// All of the state data, the event handling code, and the rendering of everything from the header
// down is now done in this new "Main" component. This was done to encapsulate the main app page
// in one place leaving the "App" component to handle the routing.
//
